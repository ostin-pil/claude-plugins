#!/usr/bin/env python3
"""Summarize the issues verify/search A/B: per scenario, model, and arm, the pass
rate and the average of each CHECKS sub-metric.

Reads runs/tally.psv (SCEN|ARM|MODEL|TRIAL|VERDICT|CHECKS|RC|REPO), where CHECKS is
scenario-specific ("targets=3/4 regressed=1/2 nontargets=2/2" or "found=1/1").
Stdlib only.
"""
